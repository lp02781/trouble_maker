...
if("TRUE" STREQUAL "TRUE")
  set(zbar_ros_SOURCE_PREFIX /home/mfikih15/trouble_maker/src/zbar_ros)
  set(zbar_ros_DEVEL_PREFIX /home/mfikih15/trouble_maker/devel)
  set(zbar_ros_INSTALL_PREFIX "")
  set(zbar_ros_PREFIX ${zbar_ros_DEVEL_PREFIX})
else()
  set(zbar_ros_SOURCE_PREFIX "")
  set(zbar_ros_DEVEL_PREFIX "")
  set(zbar_ros_INSTALL_PREFIX /home/mfikih15/trouble_maker/install)
...
if(NOT "/home/mfikih15/trouble_maker/src/zbar_ros/include " STREQUAL " ")
  set(zbar_ros_INCLUDE_DIRS "")
  set(_include_dirs "/home/mfikih15/trouble_maker/src/zbar_ros/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'zbar_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mfikih15/trouble_maker/src/zbar_ros/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT zbar_ros_NUM_DUMMY_TARGETS)
      set(zbar_ros_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::zbar_ros::wrapped-linker-option${zbar_ros_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR zbar_ros_NUM_DUMMY_TARGETS "${zbar_ros_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::zbar_ros::wrapped-linker-option${zbar_ros_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND zbar_ros_LIBRARIES "${interface_target_name}")
